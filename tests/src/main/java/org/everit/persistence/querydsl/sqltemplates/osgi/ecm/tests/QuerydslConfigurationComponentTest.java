 ...
 */
@Component(componentId = "querydslConfigurationComponentTest")
...
@StringAttributes({
    ...
    @StringAttribute(attributeId = TestRunnerConstants.SERVICE_PROPERTY_TEST_ID,
        defaultValue = "querydslConfigurationTest") })
@Service(QuerydslConfigurationComponentTest.class)
public class QuerydslConfigurationComponentTest {
  ...
  public void testThatComponentIsAlive() {
    Assert.assertNotNull("Configuration is not binded.", configuration);
  }
}
